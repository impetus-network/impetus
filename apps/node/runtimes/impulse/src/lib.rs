//! Impulse testnet runtime (chain id 322644, also used for dev mode).
...
pub use runtime_common::{
	...
	BlockWeights, DigestItem, EnableManualSeal, FindAuthorTruncated, Hash, Hashing,
...
use frame_support::{
	...
	parameter_types,
	traits::{ConstBool, ConstU32, ConstU64, ConstU8, OnFinalize},
...
impl frame_system::Config for Runtime {
	...
	/// SS58 prefix for the Impulse testnet.
...
impl pallet_timestamp::Config for Runtime {
	type Moment = u64;
	type OnTimestampSet = runtime_common::ConsensusOnTimestampSet<Self>;
...
parameter_types! {
	...
	pub PrecompilesValue: runtime_common::FrontierPrecompilesBasic<Runtime> = runtime_common::FrontierPrecompilesBasic::<_>::new();
...
impl pallet_evm::Config for Runtime {
	...
	type Currency = Balances;
	type PrecompilesType = runtime_common::FrontierPrecompilesBasic<Self>;
